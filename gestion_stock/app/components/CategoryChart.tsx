...
import { Bar, BarChart, CartesianGrid, Cell, LabelList, Legend, Rectangle, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts'
...
const CategoryChart = ({ email }: { email: string }) => {
    ...
    if (data.length == 0) {
        return (
            <div className='w-full border-4 border-base-200 mt-4 p-4 rounded-3xl'>
